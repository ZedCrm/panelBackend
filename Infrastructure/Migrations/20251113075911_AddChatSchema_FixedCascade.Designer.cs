...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251113075911_AddChatSchema_FixedCascade")]
    partial class AddChatSchema_FixedCascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Objects.Chat.ChatGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Objects.Chat.ChatGroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Objects.Chat.GroupMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Objects.Chat.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Objects.Chat.ChatGroup", b =>
                {
                    b.HasOne("Domain.Objects.Base.User", "Creator")
            ...
            modelBuilder.Entity("Domain.Objects.Chat.ChatGroupMember", b =>
                {
                    b.HasOne("Domain.Objects.Chat.ChatGroup", "Group")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Domain.Objects.Chat.GroupMessage", b =>
                {
                    ...
                    b.HasOne("Domain.Objects.Base.User", "Sender")
            ...
            modelBuilder.Entity("Domain.Objects.Chat.Message", b =>
                {
                    b.HasOne("Domain.Objects.Base.User", "Receiver")
